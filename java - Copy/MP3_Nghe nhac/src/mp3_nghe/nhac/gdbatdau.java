 ...
 * @author hai21
 */
public class gdbatdau extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         ...
         JOptionPane.showMessageDialog(this, ab.toString(),"XIN CHÀO !",JOptionPane.CLOSED_OPTION);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gdbatdau.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
